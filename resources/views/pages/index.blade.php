...
<body>
    <header>
        ...
        <div class="containerHeader">
            ...
            <li class="liIdioma" id="hamburger-button3"><img src="{{asset('assets/landing/img/global/brazil-flag-icon.050724f.webp')}}" alt="bandeira" style="width: 25px; height: 25px;"><img id="imgIdiomaDektop" src="{{asset('assets/landing/img/global/simple-arrow.svg')}}" class="imgidiomaClassDektop"></li>
            </ul>
            ...
            <div class="mobileIdioma"><img id="hamburger-button2" src="{{asset('assets/landing/img/global/brazil-flag-icon.050724f.webp')}}" alt="bandeira" style="width: 40px; height: 40px;" class="mobileHeader"> <img src="{{asset('assets/landing/img/global/simple-arrow.svg')}}" alt="" id="imgIdioma" class="imgidiomaClass"></div>
        </div>
        ...
        <div class="containerIdioma" id="menuIdioma">
            ...
            <ul>
            <li><img src="{{asset('assets/landing/img/global/brazil-flag-icon.050724f.webp')}}" alt="brasil"> Portugues</li>
            <li><img src="{{asset('assets/landing/img/global/usa-flag-icon.3230684.webp')}}" alt="brasil"> Inglês</li>
            </ul>
        </div>
    </header>
    ...
    <div class="pageWapper">
        ...
        <div class="containerGeneric">
          <div class="containerGenericInfo">
            ...
            <div class="containerButton">
              <a href="{{ route('register') }}"><button class="buttonGeneric"> Criar conta gratuita</button></a>
        ...
        <div id="solutin" class="containerSolutionList">
          ...
          $solutionListData = [
            ...
            [
                ...
                "images" => [
                    "tradeinsights-solution.svg",
                    "divi-hub-solution.svg"
                ]
            ],
            [
                "title" => "Gaming",
      ...
      <div class="containerGeneric containerSmartSignature">
        <img
          src="{{asset('assets/landing/img/home/smart-subscription.png')}}"
          alt="pessoa no noot"
        />
        <div class="containerGenericInfo">
          <div class="containerGenericTitle">
        ...
        <div class="containerGenericInfo">
          <div class="containerGenericTitle">
            ...
            <ul>
              <li>
                <img
                  src="{{asset('assets/landing/img/global/check-icon-white.svg')}}"
                  alt="icone de valido"
                />
                Sem custos mensais
              </li>
      ...
      <div class="containerGeneric containerPaymentMethods">
        <div class="containerGenericInfo">
          <div class="containerGenericTitle">
            ...
            <ul>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Pix, Boleto Bancário ou Cartão de Crédito</li>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Vendas em até 12 parcelas, independente do método de pagamento</li>
            </ul>
          </div>
      ...
      <div class="containerGeneric containerFinancialAutomation">
        ...
        <div class="containerGenericInfo containerGenericInfoWidth40">
          <div class="containerGenericTitle containerTitleNoMargin">
            ...
            <ul>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Múltiplos CNPJs por acesso</li>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Disponível para Android e iOS</li>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Mapa de vendas em tempo real</li>
            </ul>
          </div>
      ...
      <div  class="containerGeneric containerAntifraudSolution" >
        <div class="containerGenericInfo containerGenericInfoWidth40">
          <div class="containerGenericTitle containerTitleNoMargin">
            ...
            <ul>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Anti-fraude gratuito</li>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check">Visualize a análise de risco, endereço de IP de compra e demais informações únicas de cada venda</li>
            </ul>
          </div>
      ...
      <div class="containerGeneric">
        ...
        <div class="containerGenericInfo containerGenericInfoWidth40">
          <div class="containerGenericTitle containerTitleNoMargin">
            ...
            <ul>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Simples, justo, rápido e seguro</li>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> 1.99%, a melhor taxa e sem burocracia</li>
            </ul>
          </div>
      ...
      <div class="containerGeneric">
        <div class="containerGenericInfo containerGenericInfoWidth40">
          <div class="containerGenericTitle containerTitleNoMargin">
            ...
            <ul>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Integrações completas para você implementar uma solução de pagamentos white-label</li>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Suporte gratuito especializado para auxiliar você em cada etapa da sua integração</li>
              <li><img src="{{asset('assets/landing/img/global/check-icon.svg')}}" alt="check"> Integrações com Shopify, VTEX, WooCommerce e Magento</li>
            </ul>
          </div>
          ...
          <div class="info_item1">
            ...
            <div class="info_item1__list">
              ...
              <div class="info_item1__list__itens">
                <img class="react" src="{{asset('assets/landing/img/footer/white-midas-logo.png')}}" alt="logo">
                <img src="{{asset('assets/landing/img/footer/white-stanfordrebuild-logo.png')}}" alt="logo">
              </div>
            </div>
          </div>

<section class="sectionForm" id="pagamento">
    <strong class="labelContainer"><div>3</div> <p>Pagamento</p></strong>
    <strong id="aprovacao">Aprovação rápida</strong>
    <div id="containerBtnPag">
        <strong id="btn1" class="btnPag btnSelected"  onclick="primeiroBtn()"><i class="fa-regular fa-credit-card"></i> Cartão de Crédito</strong>
        <strong id="btn2" class="btnPag" onclick="segundoBtn()"><i class="fa-brands fa-pix"></i> Pix</strong>
        <strong id="btn3" class="btnPag" onclick="terceiroBtn()"><i class="fa-solid fa-barcode"></i> Boleto</strong>
    </div>
    ...
    <section id="formBoleto" class="hide">
        ...
        <li>2 - Pagamento com Boleto Bancário leva até 3 dias úteis para ser compensado e então ter os produtos liberados.</li>
        <li>3 - Você pode pagar o boleto em qualquer banco ou casa lotérica até o dia do vencimento.</li>
        <li>4 - Depois do pagamento, fique atento ao seu e-mail para receber os dados de acesso ao produto (verifique também a caixa de SPAM).</li>
        <li>Valor no boleto: <span>R$ {{ number_format($product->price, 2, ',', '.') }}</span></li>
    </section>
</section>

<section class="sectionForm" id="resumo">
    <strong class="labelContainer"><div>4</div> <p>Resumo da compra</p></strong>
    ...
    <div class="containerResumo">
        ...
        <li>
            <div class="headerLI">Estoque:</div> <div class="baseLI" style= "color: #68BC54; font-weight: bold;"><p>• Em estoque (<span>383 unidades</span>), pronto para ser enviado</p></div>
        </li>
    </div>
    <div class="containerResumo">
        <li>
            ...
            <div class="baseLI">
                <p style="color: #68BC54;">Frete Grátis <i class="fa-solid fa-bolt"></i> <i style="font-weight: bold;">Full</i><span style="color:#0056B3;"> • Disponível</span><br><span style="color: #545454;">Enviado pelos Correios</span></p>
            </div>
        </li>
        <li>

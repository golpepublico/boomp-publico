...
<div id="config">
    ...
    <div class="titulo">
        ...
        <h2 class="text-title">Add Integrações Pixels</h2>
    </div>
    ...
    <form action="{{ route('pixel.store') }}" method="post">
        ...
        <div class="card">
            ...
            <div class="form-row">
                ...
                <input id="nome-loja" name="pixel_key" type="text" value="">
            </div>

            <div class="form-row">
                <label for="nome">Ativar o pixel pagamento por cartão de crédito *</label>
                <label class="switch">
                    <input type="checkbox" name="fl_pixel_cred" id="fl_pixel_cred">
            ...
            <div class="form-row">
                ...
                <label class="switch">
                    <input type="checkbox" name="fl_pixel_pix" id="fl_pixel_pix">
                    <div class="slider round">
                        <span class="on">Sim</span>
                        <span class="off">Não</span>
                    </div>
            ...
            <div class="form-row">
                ...
                <label class="switch">
                    <input type="checkbox" name="fl_pixel_boleto" id="fl_pixel_boleto">
                    <div class="slider round">
                        <span class="on">Sim</span>
                        <span class="off">Não</span>
                    </div>
